...
Create a new branch. The branch name will used in the URL for the training environment, so pick something short and relevant to the workshop (no uppercase letters and no special characters, `_ , . ` etc.). For example, *ml101*, *introtor*, etc.
